...
export default function VideoPortalContainer() {
  ...
  if (hasToRender) {
    ...
    // Only apply first/last element logic when inside a slick carousel.
    // In grid contexts (e.g., genre page), parentElement is null,
    // so we keep the default centered positioning (varZoomIn).
    if (parentElement) {
