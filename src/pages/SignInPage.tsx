...
export function Component() {
  ...
  const { login, googleLogin: authGoogleLogin, isLoading } = useAuth();
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (!email || !password) {
      setError("Please fill all the details carefully");
      return;
    }
    ...
    >
      ...
      >
        ...
        >
          ...
          <Stack spacing={2} component="form" onSubmit={handleSignIn}>
            <TextField
              variant="filled"
